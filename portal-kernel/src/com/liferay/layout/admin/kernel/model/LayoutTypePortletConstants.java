...
public class LayoutTypePortletConstants
	...
	private static final Set<String> _typeSettingsIds = SetUtil.fromArray(
		...
		LAST_IMPORT_USER_NAME, LAST_IMPORT_USER_UUID, LAYOUT_TEMPLATE_ID,
		LAYOUT_UPDATEABLE, LINK_TO_LAYOUT_ID, MERGE_FAIL_COUNT, MODE_ABOUT,
		MODE_CONFIG, MODE_EDIT, MODE_EDIT_DEFAULTS, MODE_EDIT_GUEST, MODE_HELP,
		MODE_PREVIEW, MODE_PRINT, MODIFIED_DATE, NESTED_COLUMN_IDS,
		PANEL_LAYOUT_DESCRIPTION, PANEL_SELECTED_PORTLETS, PRIVATE_LAYOUT,
		QUERY_STRING, SITEMAP_CHANGEFREQ, SITEMAP_INCLUDE, SITEMAP_PRIORITY,
		STATE_MAX, STATE_MIN, STATIC_PORTLET_ORGANIZATION_SELECTOR,
