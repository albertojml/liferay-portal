 ...
 */
@Generated("")
@GraphQLName("SuccessResponse")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SuccessResponse")
public class SuccessResponse implements Serializable {

	public static SuccessResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(SuccessResponse.class, json);
	}

	public static SuccessResponse unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SuccessResponse.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.portal.tools.rest.builder.test.dto.v1_0.SuccessResponse",
		name = "x-class-name"
	)
