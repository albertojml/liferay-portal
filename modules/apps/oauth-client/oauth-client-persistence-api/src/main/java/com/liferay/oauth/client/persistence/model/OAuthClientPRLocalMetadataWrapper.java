...
public class OAuthClientPRLocalMetadataWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("authorizationServers", getAuthorizationServers());
		attributes.put("bearerMethodsSupported", getBearerMethodsSupported());
		...
		attributes.put("resourceDocumentation", getResourceDocumentation());
		attributes.put("scopesSupported", getScopesSupported());
		attributes.put("signedMetadataEnabled", isSignedMetadataEnabled());
		attributes.put("signedMetadataKeyAlias", getSignedMetadataKeyAlias());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String authorizationServers = (String)attributes.get(
			"authorizationServers");

		if (authorizationServers != null) {
			setAuthorizationServers(authorizationServers);
		}

		String bearerMethodsSupported = (String)attributes.get(
			"bearerMethodsSupported");

		if (bearerMethodsSupported != null) {
			setBearerMethodsSupported(bearerMethodsSupported);
		}
		...
		String resourceDocumentation = (String)attributes.get(
			"resourceDocumentation");

		if (resourceDocumentation != null) {
			setResourceDocumentation(resourceDocumentation);
		}

		String scopesSupported = (String)attributes.get("scopesSupported");

		if (scopesSupported != null) {
			setScopesSupported(scopesSupported);
		}

		Boolean signedMetadataEnabled = (Boolean)attributes.get(
			"signedMetadataEnabled");

		if (signedMetadataEnabled != null) {
			setSignedMetadataEnabled(signedMetadataEnabled);
		}

		String signedMetadataKeyAlias = (String)attributes.get(
			"signedMetadataKeyAlias");

		if (signedMetadataKeyAlias != null) {
			setSignedMetadataKeyAlias(signedMetadataKeyAlias);
		}
	}
	...
	/**
	 * Returns the authorization servers of this o auth client pr local metadata.
	 *
	 * @return the authorization servers of this o auth client pr local metadata
	 */
	@Override
	public String getAuthorizationServers() {
		return model.getAuthorizationServers();
	}

	/**
	 * Returns the bearer methods supported of this o auth client pr local metadata.
	 *
	 * @return the bearer methods supported of this o auth client pr local metadata
	 */
	@Override
	public String getBearerMethodsSupported() {
		return model.getBearerMethodsSupported();
	}
	...
	/**
	 * Returns the jwks uri of this o auth client pr local metadata.
	 *
	 * @return the jwks uri of this o auth client pr local metadata
	 */
	@Override
	...
	/**
	 * Returns the resource documentation of this o auth client pr local metadata.
	 *
	 * @return the resource documentation of this o auth client pr local metadata
	 */
	@Override
	public String getResourceDocumentation() {
		return model.getResourceDocumentation();
	}

	/**
	 * Returns the scopes supported of this o auth client pr local metadata.
	 *
	 * @return the scopes supported of this o auth client pr local metadata
	 */
	@Override
	public String getScopesSupported() {
		return model.getScopesSupported();
	}

	/**
	 * Returns the signed metadata enabled of this o auth client pr local metadata.
	 *
	 * @return the signed metadata enabled of this o auth client pr local metadata
	 */
	@Override
	public boolean getSignedMetadataEnabled() {
		return model.getSignedMetadataEnabled();
	}

	/**
	 * Returns the signed metadata key alias of this o auth client pr local metadata.
	 *
	 * @return the signed metadata key alias of this o auth client pr local metadata
	 */
	@Override
	public String getSignedMetadataKeyAlias() {
		return model.getSignedMetadataKeyAlias();
	}
	...
	/**
	 * Returns <code>true</code> if this o auth client pr local metadata is signed metadata enabled.
	 *
	 * @return <code>true</code> if this o auth client pr local metadata is signed metadata enabled; <code>false</code> otherwise
	 */
	@Override
	public boolean isSignedMetadataEnabled() {
		return model.isSignedMetadataEnabled();
	}
	...
	/**
	 * Sets the authorization servers of this o auth client pr local metadata.
	 *
	 * @param authorizationServers the authorization servers of this o auth client pr local metadata
	 */
	@Override
	public void setAuthorizationServers(String authorizationServers) {
		model.setAuthorizationServers(authorizationServers);
	}

	/**
	 * Sets the bearer methods supported of this o auth client pr local metadata.
	 *
	 * @param bearerMethodsSupported the bearer methods supported of this o auth client pr local metadata
	 */
	@Override
	public void setBearerMethodsSupported(String bearerMethodsSupported) {
		model.setBearerMethodsSupported(bearerMethodsSupported);
	}
	...
	/**
	 * Sets the jwks uri of this o auth client pr local metadata.
	 *
	 * @param jwksURI the jwks uri of this o auth client pr local metadata
	 */
	@Override
	...
	/**
	 * Sets the resource documentation of this o auth client pr local metadata.
	 *
	 * @param resourceDocumentation the resource documentation of this o auth client pr local metadata
	 */
	@Override
	public void setResourceDocumentation(String resourceDocumentation) {
		model.setResourceDocumentation(resourceDocumentation);
	}

	/**
	 * Sets the scopes supported of this o auth client pr local metadata.
	 *
	 * @param scopesSupported the scopes supported of this o auth client pr local metadata
	 */
	@Override
	public void setScopesSupported(String scopesSupported) {
		model.setScopesSupported(scopesSupported);
	}

	/**
	 * Sets whether this o auth client pr local metadata is signed metadata enabled.
	 *
	 * @param signedMetadataEnabled the signed metadata enabled of this o auth client pr local metadata
	 */
	@Override
	public void setSignedMetadataEnabled(boolean signedMetadataEnabled) {
		model.setSignedMetadataEnabled(signedMetadataEnabled);
	}

	/**
	 * Sets the signed metadata key alias of this o auth client pr local metadata.
	 *
	 * @param signedMetadataKeyAlias the signed metadata key alias of this o auth client pr local metadata
	 */
	@Override
	public void setSignedMetadataKeyAlias(String signedMetadataKeyAlias) {
		model.setSignedMetadataKeyAlias(signedMetadataKeyAlias);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:2116952908