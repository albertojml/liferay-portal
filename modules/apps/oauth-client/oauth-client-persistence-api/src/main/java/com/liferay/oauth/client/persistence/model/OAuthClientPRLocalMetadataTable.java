...
public class OAuthClientPRLocalMetadataTable
	...
	public final Column<OAuthClientPRLocalMetadataTable, String>
		bearerMethodsSupported = createColumn(
			"bearerMethodsSupported", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
	public final Column<OAuthClientPRLocalMetadataTable, String> jwksURI =
		createColumn(
	...
	public final Column<OAuthClientPRLocalMetadataTable, Boolean>
		signedMetadataEnabled = createColumn(
			...
			Column.FLAG_DEFAULT);
	public final Column<OAuthClientPRLocalMetadataTable, String>
		signedMetadataKeyAlias = createColumn(
			"signedMetadataKeyAlias", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
