...
public class OAuthClientPRLocalMetadataPersistenceImpl
	...
	/**
	 * Caches the o auth client pr local metadata in the entity cache if it is enabled.
	 *
	...
	public void cacheResult(
		...
		entityCache.putResult(
			...
			oAuthClientPRLocalMetadata.getPrimaryKey(),
	...
	/**
	 * Caches the o auth client pr local metadatas in the entity cache if it is enabled.
	 *
	 * @param oAuthClientPRLocalMetadatas the o auth client pr local metadatas
	 */
	@Override
	public void cacheResult(
		List<OAuthClientPRLocalMetadata> oAuthClientPRLocalMetadatas) {
		...
		for (OAuthClientPRLocalMetadata oAuthClientPRLocalMetadata :
			...
			if (entityCache.getResult(
					OAuthClientPRLocalMetadataImpl.class,
					oAuthClientPRLocalMetadata.getPrimaryKey()) == null) {

				cacheResult(oAuthClientPRLocalMetadata);
			}
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			oAuthClientPRLocalMetadataModelImpl.getCompanyId(),
			oAuthClientPRLocalMetadataModelImpl.getResource()
		};

		finderCache.putResult(
			_finderPathFetchByC_R, args, oAuthClientPRLocalMetadataModelImpl);

		args = new Object[] {
			oAuthClientPRLocalMetadataModelImpl.getCompanyId(),
			oAuthClientPRLocalMetadataModelImpl.getLocalWellKnownURI()
		};
		...
		args = new Object[] {
			oAuthClientPRLocalMetadataModelImpl.getExternalReferenceCode(),
			oAuthClientPRLocalMetadataModelImpl.getCompanyId()
		};

		finderCache.putResult(
			_finderPathFetchByERC_C, args, oAuthClientPRLocalMetadataModelImpl);
	}
	...
	public OAuthClientPRLocalMetadata updateImpl(
		...
		entityCache.putResult(
			OAuthClientPRLocalMetadataImpl.class,
			oAuthClientPRLocalMetadataModelImpl, false, true);

		cacheUniqueFindersCache(oAuthClientPRLocalMetadataModelImpl);
	...
	public void activate() {
		...
		_finderPathFetchByC_R = new FinderPath(
			...
			new String[] {"companyId", "resource"}, true);
...
// LIFERAY-SERVICE-BUILDER-HASH:-1713853768