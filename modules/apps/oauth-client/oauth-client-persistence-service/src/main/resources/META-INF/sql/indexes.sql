...
create unique index IX_E3839C6 on OAuthClientPRLocalMetadata (companyId, localWellKnownURI[$COLUMN_LENGTH:75$]);
create unique index IX_BF510D8E on OAuthClientPRLocalMetadata (companyId, resource[$COLUMN_LENGTH:75$]);
