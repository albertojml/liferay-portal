...
public class OAuthClientPRLocalMetadataPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newOAuthClientPRLocalMetadata.setAuthorizationServers(
			RandomTestUtil.randomString());

		newOAuthClientPRLocalMetadata.setBearerMethodsSupported(
			RandomTestUtil.randomString());

		newOAuthClientPRLocalMetadata.setJwksURI(RandomTestUtil.randomString());
		...
		newOAuthClientPRLocalMetadata.setResourceDocumentation(
			RandomTestUtil.randomString());

		newOAuthClientPRLocalMetadata.setScopesSupported(
			RandomTestUtil.randomString());

		newOAuthClientPRLocalMetadata.setSignedMetadataEnabled(
			RandomTestUtil.randomBoolean());

		newOAuthClientPRLocalMetadata.setSignedMetadataKeyAlias(
			RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingOAuthClientPRLocalMetadata.getAuthorizationServers(),
			newOAuthClientPRLocalMetadata.getAuthorizationServers());
		Assert.assertEquals(
			existingOAuthClientPRLocalMetadata.getBearerMethodsSupported(),
			newOAuthClientPRLocalMetadata.getBearerMethodsSupported());
		Assert.assertEquals(
			existingOAuthClientPRLocalMetadata.getJwksURI(),
			newOAuthClientPRLocalMetadata.getJwksURI());
		Assert.assertEquals(
		...
		Assert.assertEquals(
			existingOAuthClientPRLocalMetadata.getResourceDocumentation(),
			newOAuthClientPRLocalMetadata.getResourceDocumentation());
		Assert.assertEquals(
			existingOAuthClientPRLocalMetadata.getScopesSupported(),
			newOAuthClientPRLocalMetadata.getScopesSupported());
		Assert.assertEquals(
			existingOAuthClientPRLocalMetadata.isSignedMetadataEnabled(),
			newOAuthClientPRLocalMetadata.isSignedMetadataEnabled());
		Assert.assertEquals(
			existingOAuthClientPRLocalMetadata.getSignedMetadataKeyAlias(),
			newOAuthClientPRLocalMetadata.getSignedMetadataKeyAlias());
	}
	...
	protected OAuthClientPRLocalMetadata addOAuthClientPRLocalMetadata()
		...
		oAuthClientPRLocalMetadata.setJwksURI(RandomTestUtil.randomString());
