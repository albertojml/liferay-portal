...
public class OpenAPIUtilTest {
	...
	public void testGetRequest() throws Exception {
		...
		request = OpenAPIUtil.getRequest(
			...
			_openAPIJSONObject, "name", "postBinary", null);
	...
	public void testGetTool() throws Exception {
		...
		Map<String, ?> bodyMap = _getBodyMap("string", "postItem");
		...
		bodyMap = _getBodyMap("next.name", "postLevel");
		...
		bodyMap = _getBodyMap("next", "postLevel");
		...
		bodyMap = _getBodyMap("string", "postBatch");
	...
	private Map<String, ?> _getBodyMap(String restrictFields, String toolName) {
	...
	private Map<String, ?> _getPropertiesMap(
		...
		Tool tool = OpenAPIUtil.getTool(
			true, _openAPIJSONObject, restrictFields, toolName);
