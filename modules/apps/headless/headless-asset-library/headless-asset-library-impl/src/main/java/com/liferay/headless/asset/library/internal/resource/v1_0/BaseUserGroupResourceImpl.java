...
public abstract class BaseUserGroupResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-asset-library/v1.0/asset-libraries/{externalReferenceCode}/user-groups'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/asset-libraries/{externalReferenceCode}/user-groups")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-asset-library/v1.0/asset-libraries/{externalReferenceCode}/user-groups/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Path(
		"/asset-libraries/{externalReferenceCode}/user-groups/export-batch"
	)
	@jakarta.ws.rs.POST
