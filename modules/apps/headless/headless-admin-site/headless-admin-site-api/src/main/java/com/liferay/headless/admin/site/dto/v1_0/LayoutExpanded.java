 ...
 */
@Generated("")
@GraphQLName("LayoutExpanded")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "LayoutExpanded")
public class LayoutExpanded implements Serializable {

	public static LayoutExpanded toDTO(String json) {
		return ObjectMapperUtil.readValue(LayoutExpanded.class, json);
	}

	public static LayoutExpanded unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(LayoutExpanded.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.LayoutExpanded",
		name = "x-class-name"
	)
