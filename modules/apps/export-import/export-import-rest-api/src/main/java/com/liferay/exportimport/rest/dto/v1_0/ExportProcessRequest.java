...
public class ExportProcessRequest implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Whether to export the site's favicon, part of the site's look-and-feel carried on the layout set."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Whether to export the site's layout set settings, the look-and-feel configuration of the site."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Whether to export the site's logo image, part of the site's look-and-feel."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Whether to export the site's theme and color scheme (look-and-feel). The theme rides on the site's layout set rather than being a standalone entity."
	)
