	...
	public static class ExportProcessResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/export-import/v1.0/asset-libraries/{assetLibraryId}/export-processes");
		...
		public HttpInvoker.HttpResponse getSiteExportProcessesPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/export-import/v1.0/sites/{siteId}/export-processes");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/export-import/v1.0/asset-libraries/{assetLibraryId}/export-processes/export-batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/export-import/v1.0/sites/{siteId}/export-processes/export-batch");
...
// LIFERAY-REST-BUILDER-HASH:-2080134037