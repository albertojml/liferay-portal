...
>
	...
	for (Portlet portlet : portlets) {
		...
		long exportModelCount = 0;

		if (portletDataHandler.isModelCountSupported()) {
			exportModelCount = portletDataHandler.getExportModelCount(manifestSummary);
		}
		else {
			exportModelCount = portletDataHandler.getExportModelCount(portletDataContext.getCompanyId(), portletDataContext.getCompanyGroupId());
		}
